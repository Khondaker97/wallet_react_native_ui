  ...
  function renderHeader() {
    return (
      <View style={{flexDirection: 'row', marginVertical: SIZES.padding * 2}}>
        <View style={{flex: 1}}>
          <Text style={{...FONTS.h1, color: COLORS.black, fontWeight: '700'}}>
            Hello!
          </Text>
          <Text style={{...FONTS.body2, color: COLORS.gray}}>Pollob</Text>
        </View>
    ...
    function Header() {
      return (
        <View style={{marginBottom: SIZES.padding * 2}}>
          <Text style={{...FONTS.h3, fontWeight: '700', color: COLORS.black}}>
            Features
          </Text>
        </View>
      );
